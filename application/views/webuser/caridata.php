...
<body>
    ...
    <ul>
      ...
      <!-- <div class="main-row"><li><a class="active" href="<?php echo base_url()?>Aktakelahiran/indexweb">Akta Kelahiran</a></li></div> -->
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>AKtakelahiran/bantuankelahiran">Bantuan</a></li></div>
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>Aktakelahiran/indexweb">Kembali</a></li></div>
    </ul>
...
<!-- <?php
  $no=1;
    ...
    ?>
          ...
          <form action="<?php print site_url();?>pelayanan/monitoring" method="get">
            Cari NIK Anda:
