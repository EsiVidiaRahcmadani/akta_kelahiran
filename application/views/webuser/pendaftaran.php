...
<body>
    ...
    <ul>
      ...
      <!-- <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>">Bantuan</a></li></div> -->
  ...
  <div class="main">
    ...
    <form action="<?php echo base_url()?>Pendaftaran/daftar" method="POST">
      <table>
          ...
          <input type="hidden" id="sts" name="status" value="Belum Selesai" required><br>

          <div align="center"><button type="submit" value="Simpan" name="post">Simpan</button></div>
