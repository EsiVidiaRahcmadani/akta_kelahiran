...
<!-- <?php
  $no=1;
    ...
    ?>
          ...
          <form action="<?php print site_url();?>pelayanan/monitoring" method=POST>
            Cari NIK Anda:
              ...
              <tbody>
                    <?php foreach($akta as $row) { ?>
                          <tr>
                            ...
                            <td><div align="center"><?php echo $row->nama_ibu; ?></div></td>
                            ...
                            <a href="<?php echo site_url('pelayanan/lihat_berkas/'.$row->nik)?>" type="button" class="fa fa-eye"><b> Lihat | </b></a>
                            <a href="<?php echo base_url()?>cetak/cetak_kelahiran/<?php print $row->nik; ?>" type="button" target="_blank" class="fa fa-print"><b> Cetak</b></a></div></td>
                         </tr>
                         <?php } ?>
             </tbody>
         </table><br>  
