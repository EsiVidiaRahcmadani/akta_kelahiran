                           ...
                           <div class="menu">
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href=""><i class="fa fa-file-text-o"></i> <span>Data User</span><span class="fa fa-angle-right" style="float: right"></span></a>
											...
											<li id="menu-academico-boletim" ><a href="<?php echo base_url()?>user">Data Pendaftar</a></li>
										    <li id="menu-academico-boletim" ><a href="<?php echo base_url()?>loket">Data Pengelola</a></li>
										</ul>
											</li>
										<li id="menu-academico" ><a href=""><i class="fa fa-pencil-square-o"></i> <span>Kelola Akta</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										  <ul id="menu-academico-sub" >
										    <li id="menu-academico-boletim" ><a href="<?php echo base_url()?>akta">Akta Kelahiran</a></li>
										    <li id="menu-academico-boletim" ><a href="<?php echo base_url()?>berkas">Berkas</a></li>
										  </ul>
									 	</li>
								  </ul>
								</div>
